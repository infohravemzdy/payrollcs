...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_14_MarginIncomeOfTaxBonusTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_14_MarginIncomeOfTaxBonusTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_14_MarginIncomeOfTaxBonus
            LogTestExamples("04_Taxing_14_MarginIncomeOfTaxBonus.txt", _tests);
#endif
        }
        [Theory]
