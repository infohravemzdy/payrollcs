...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_13_MaxAmountOfTaxBonusTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_13_MaxAmountOfTaxBonusTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_13_MaxAmountOfTaxBonus
            LogTestExamples("04_Taxing_13_MaxAmountOfTaxBonus.txt", _tests);
#endif
        }
        [Theory]
