...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_12_MinAmountOfTaxBonusTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_12_MinAmountOfTaxBonusTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_12_MinAmountOfTaxBonus
            LogTestExamples("04_Taxing_12_MinAmountOfTaxBonus.txt", _tests);
#endif
        }
        [Theory]
