...
namespace LegaliosUnitTest.ServiceTest
{
    ...
    public class Service_Legalios_Example_04_Taxing_18_MarginIncomeOfWthEmpTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_18_MarginIncomeOfWthEmpTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_18_MarginIncomeOfWthEmp
            LogTestExamples("04_Taxing_18_MarginIncomeOfWthEmp.txt", _tests);
#endif
        }
        [Theory]
