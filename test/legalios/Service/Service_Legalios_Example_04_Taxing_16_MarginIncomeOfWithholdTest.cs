...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_16_MarginIncomeOfWithholdTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_16_MarginIncomeOfWithholdTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_16_MarginIncomeOfWithhold
            LogTestExamples("04_Taxing_16_MarginIncomeOfWithhold.txt", _tests);
#endif
        }
        [Theory]
