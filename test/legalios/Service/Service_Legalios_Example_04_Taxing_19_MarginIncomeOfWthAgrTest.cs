...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_19_MarginIncomeOfWthAgrTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_19_MarginIncomeOfWthAgrTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_19_MarginIncomeOfWthAgr
            LogTestExamples("04_Taxing_19_MarginIncomeOfWthAgr.txt", _tests);
#endif
        }
        [Theory]
