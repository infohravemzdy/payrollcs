...
namespace Procezor.PayrolexTest.Service
{
    public class ServiceTestExampleTemplate
    {
        ...
        protected static readonly ExampleGenerator[] _genTests = new ExampleGenerator[] {
            ...
            ExampleGenerator.Spec(150, "PP-Mzda_DanPoj-ZaporPlat",        "150").WithContracts(ContractGenerator.SpecEmp(1).WithSalary(ConValue(-10000))), //, CZK 110000   ,  YES          ,  YES          ,  YES          ,  YES          ,  YES          ,  NO            ,  YES               , 0,  NO, NO, NO               ,  NO                   ,  YES             ,  YES             , 
            ExampleGenerator.Spec(151, "PP-Mzda_DanPoj-ZaporDohod",       "151").WithContracts(ContractGenerator.SpecEmp(1).WithSalary(ConValue(0)).WithAgreem(ConValue(-5000))), //, CZK -5000   ,  YES          ,  YES          ,  YES          ,  YES          ,  YES          ,  NO            ,  YES               , 0,  NO, NO, NO               ,  NO                   ,  YES             ,  YES             , 
            ExampleGenerator.Spec(153, "PP-Mzda_NepodPoj-ZaporPlat",      "153").WithContracts(ContractGenerator.SpecEmp(1).WithSalary(ConValue(-10000))).WithTaxDecl(GenValue(0)), //, CZK 110000   ,  YES          ,  YES          ,  YES          ,  YES          ,  YES          ,  NO            ,  YES               , 0,  NO, NO, NO               ,  NO                   ,  YES             ,  YES             , 
            ExampleGenerator.Spec(154, "PP-Mzda_NepodPoj-ZaporDohod",     "154").WithContracts(ContractGenerator.SpecEmp(1).WithSalary(ConValue(0)).WithAgreem(ConValue(-5000))).WithTaxDecl(GenValue(0)), //, CZK -5000   ,  YES          ,  YES          ,  YES          ,  YES          ,  YES          ,  NO            ,  YES               , 0,  NO, NO, NO               ,  NO                   ,  YES             ,  YES             , 
            ...
            ExampleGenerator.Spec(751, "MPOM2-PPOM-Mzda_MinZdrav",     "751").WithContracts(
                ...
                ContractGenerator.SpecEmp(2)
                    .WithSalary(Div(UcastNem(1), 2, 1))
                    .WithSocialLoIncome(ConValue(1)),
                ContractGenerator.SpecEmp(3).WithPriority(IIf(YearBW(2014, 2021), ConValue(3), ConValue(0)))
            ...
            ExampleGenerator.Spec(761, "MPOM2-PPOM-Mzda_MaxZdrav",     "761").WithContracts(
                ContractGenerator.SpecEmp(1).WithPriority(IIf(YearBW(2014,2021), ConValue(1), ConValue(0)))
                    .WithSalary(Div(UcastNem(1), 2, 1))
                    .WithSocialLoIncome(ConValue(1)),
                ContractGenerator.SpecEmp(2).WithPriority(IIf(YearBW(2014,2021), ConValue(2), ConValue(0)))
                    .WithSalary(Div(UcastNem(1), 2, 1))
                    .WithSocialLoIncome(ConValue(1)),
                ContractGenerator.SpecEmp(3).WithPriority(IIf(YearBW(2014,2021), ConValue(3), ConValue(0)))
            ...
            ExampleGenerator.Spec(771, "MPOM2-PPOM-Mzda_MaxSocial",     "771").WithContracts(
                ContractGenerator.SpecEmp(1).WithPriority(IIf(YearBW(2014,2021), ConValue(2), ConValue(0)))
                    .WithSalary(Div(UcastNem(1), 2, 1))
                    .WithSocialLoIncome(ConValue(1)),
                ContractGenerator.SpecEmp(2).WithPriority(IIf(YearBW(2014,2021), ConValue(1), ConValue(0)))
                    .WithSalary(Div(UcastNem(1), 2, 1))
                    .WithSocialLoIncome(ConValue(1)),
                ContractGenerator.SpecEmp(3).WithPriority(IIf(YearBW(2014,2021), ConValue(3), ConValue(0)))
